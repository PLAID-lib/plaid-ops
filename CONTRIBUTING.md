# Contributing to PLAID-ops Project

Thank you for your interest in contributing to PLAID-ops Project! We welcome contributions from the community to help make this project even better.
...
**TIP:**
The 'format.sh' script at the root of the project allows you to format all the python files in the project under the PEP8 convention.
...
If you encounter a problem with PLAID-ops Project or have found a bug, please check the [existing issues](https://github.com/PLAID-lib/plaid-ops/issues) to see if it has already been reported. If not, feel free to [open a new issue](https://github.com/PLAID-lib/plaid-ops/issues/new) with the following information:

- A clear and concise description of the issue.
- Steps to reproduce the issue.
- The expected behavior.
- The version of PLAID-ops Project you are using.
- Any relevant screenshots or error messages.

## 3. Feature Requests

If you have an idea for a new feature or enhancement, please [open a new issue](https://github.com/PLAID-lib/plaid-ops/issues/new) and provide the following details:
...
Thank you for considering contributing to PLAID-ops Project! Your help is greatly appreciated.
